...
class PyBulletHunter(Node):
    def __init__(self):
        ...
        self.joint_names = {p.getJointInfo(self.robot, i)[1].decode(): i
        ...
        self.get_logger().info(f"Joint IDs: FLsteer={self.fl_steer}, FRsteer={self.fr_steer}, "
        ...
        # ROS I/O
        self.sub = self.create_subscription(AckermannDriveStamped, '/cmd',
    ...
    def cmd_callback(self, msg: AckermannDriveStamped):
        ...
        self.delta_cmd = max(-self.max_steer,
                             min(self.max_steer,
    ...
    def update(self):
        ...
        p.setJointMotorControl2(self.robot, self.fl_steer,
                                controlMode=p.POSITION_CONTROL,
                                targetPosition=steer_angle, force=3.0)
        p.setJointMotorControl2(self.robot, self.fr_steer,
                                controlMode=p.POSITION_CONTROL,
                                targetPosition=steer_angle, force=3.0)
